...
ROOT_PACKAGE=github.com/openkf/website
...
IMAGE_REGISTRY ?= openkf/openkf-hugo
IMAGE_VERSION=$(shell scripts/hash-files.sh Dockerfile Makefile | cut -c 1-12)
CONTAINER_IMAGE   = docker pull openkf/openkf-hugo
...
install.hugo:
	...
	tar -zxvf hugo_extended_0.118.2_linux-amd64.tar.gz -C $(OUTPUT_DIR)/tools
	rm -rf hugo_extended_0.118.2_linux-amd64.tar.gz